...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Pharmacare Customer- Login</title>
    ...
    <script>
      ...
      if(xhttp.responseText == "")
        window.location.href = "http://localhost/customer/index.html";
      if(xhttp.responseText == "true")
        window.location.href = "http://localhost/customer/customerlogin.php";
  ...
  <body>
    <div class="container">
      ...
      <div id="login-form" class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="customerlogin.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="images/profile.png" class="profile"/>
              <h1 class="logo-caption"><span class="tweak">P</span>HARMA<span class="tweak">C</span>ARE</h1>
        			<h1 class="logo-caption"><span class="tweak">C</span>ustomer<span class="tweak">L</span>ogin</h1>
        		</div> <!-- logo class -->

...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php include("sections/customersidenav.html"); ?>
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="old_password" type="text" class="form-control" placeholder="old password" onblur="checkCustomerPassword(this.value, 'old_password_error');">
